...
public class DoubleUtilities
{
	...
	public static void main(String[] args){
		...
		/*System.out.println("This will be example test, no reading from file);
		
		int testNum = 0;
		String req = "Utilities methods behave as expected";
		String comp = "DoubleUtilities.java";
		String meth = "public static String toStringForData(double doubleToConvert)";
